...
$empty_product = (object)[
	...
	"description"=>"It cleans the lens on cameras",
	"price"=>"9.99",
	"category"=>"di",
	"thumbnail"=>"di_iklipselfietripod.jpg",
	"images"=>"di_iklipselfietripod.jpg",
	"quantity"=>"23"
];
...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
	...
	<div class="form-control">
		<label class="form-label" for="product-description">Descripton</label>
