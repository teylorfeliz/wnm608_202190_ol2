            ...
            <form class="form">
            	<h3>Address</h3>
           		<div class="form-control">
		           	<label for="address-street" class="form-label">Stress</label>
		            <input id="address-street" type="text" placeholder="Street name" class="form-input">
	            </div>
	            <div class="form-control">
	            	<div class="grid gap">
	            		<div class="col-xs-12 col-md-6">
							<label for="address-cityt" class="form-label">City</label>
		         		    <input id="address-cityt" type="text" placeholder="City" class="form-input">
		            	</div>
	            		<div class="col-xs-12 col-md-6">
		        ...
		        <div class="form-control">
		         	...
		         	<a href="main_confirmation.php" class="form-button">Complete Checkout</a>
		        </div>
		    </form>
		</div>
	</div>
