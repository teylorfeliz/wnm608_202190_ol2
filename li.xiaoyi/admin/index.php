...
$form = <<<HTML
	<div>
		...
		<div class = "form-control">
			...
			<input class="form-input" name="product-stock" id="product-stock" type="number" min="0" max="1000" step="1" value="$o->stock" placeholder="Enter the Stock Quantity">
		</div>
		<div class = "form-control">
		...
		<div class = "form-control">
			...
			<input class="form-input" name="product-image" id="product-image" type="text" value="$o->images" placeholder="Enter the Product Images">
		</div>
		<div class = "form-control">
