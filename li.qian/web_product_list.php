	...
	<div class="container">
		...
		<div class="form-control">
			...
			<div class="display-flex">
				...
				<div class="flex-none">
					<button data-filter="category" data-value="fruit" type="button" class="form-button" style="padding: 5px; margin: 5px;">Fruit</button>
				</div>
				<div class="flex-none">
					<button data-filter="category" data-value="vegetable" type="button" class="form-button" style="padding: 5px; margin: 5px;">Vegetable</button>
				</div>
				</div>
				<div class="flex-none">
