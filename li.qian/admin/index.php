...
function showProductPage($o){
	...
	<div class="form-control">
		<label class="form-label" style="color: gray;">Quantity</label>
		<span>$o->quantity</span>
	</div>
	<div class="form-control">
		<label class="form-label" style="color: gray;">Category</label>
		<span>$o->category</span>
	</div>
	<div class="form-control">
		<label class="form-label" style="color: gray;">Description</label>
...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
	...
	<div class="form-control">
		<label class="form-label" for="product-name" style="color: gray;">Name</label>
		<input class="form-input" name="product-name" id="product-name" type="text" value="$o->name" placeholder="Enter the Product Name">
	</div>
	<div class="form-control">
		<label class="form-label" for="product-price" style="color: gray;">Price</label>
	...
	<div class="form-control">
		<label class="form-label" for="product-quantity" style="color: gray;">Quantity</label>
	...
	<div class="form-control">
		<label class="form-label" for="product-category" style="color: gray;">Category</label>
	...
	<div class="form-control">
		<label class="form-label" for="product-description" style="color: gray;">Description</label>
	...
	<div class="form-control">
		<label class="form-label" for="product-images" style="color: gray;">Images</label>
